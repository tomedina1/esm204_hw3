...
**Figure 1:** 
The plot shows the demand of electricity between high income and low income consumers along with the aggregated demanded curve and marginal external cost.
...
**Figure 2**: 
The figure shows the demand of low and high consumers for electricity with a tax. This also shows the adjusted MEC and aggregated demand. 
...
**Figure 3:** The above table shows the overall welfare for high income consumers, low income consumers, and electricity producers through the implementation of the tax. 
...
ggplot(solar_agg) +
  ...
  guides(linetype = FALSE) +
  theme_minimal() +
  labs(x = "Quantity Demanded (kWh)", y = "Price (cents)", title = "Figure 4: Electricity Demand Curve for High Income Consumers After Solar Access")
...
**Figure 3:** The above figure shows the new demand curve of electricity for high income consumers after access to home solar generation. 
