...
ggplot(agg_demand) +
  ...
  theme_minimal() +
  labs(x = "Quantity Demanded (kWh)", y = "Price (cents)")
```
...
- The consumer surplus of the low consumers is $`r round(cs_low,2)/ 100`.

- The consumer surplus of the high consumers is $`r round(cs_high, 2) / 100`.

- The total benefit is $`r round(cs_aggr, 2) / 100`.
